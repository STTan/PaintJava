...
//Car la classe Rectangle existe deja!
public class MonRectangle extends Forme {
	private int longueur;
	private int hauteur;
	private int xInitial;
	private int yInitial;

	public MonRectangle (Point pointDebut, Point pointFin, Color saCouleur, Color saCouleur2, boolean formeRempli)
	{
