...
public class Cercle extends Forme {
	...
	public Cercle (Point pointDebut, Point pointFin, Color saCouleur, Color saCouleur2, boolean formeRempli)
	{
	    ...
	    //Pour dessiner un cercle, les coordonnées du point initial est toujours l'opposé
	    //du point de fin.
